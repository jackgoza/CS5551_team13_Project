...
var WelcomePage = /** @class */ (function () {
    ...
    WelcomePage.prototype.skip1 = function () {
        this.navCtrl.push('TabsPage');
    };
    WelcomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-welcome',template:/*ion-inline-start:"J:\5551Project\IonicMaxApp\src\pages\welcome\welcome.html"*/'<ion-content scroll="false">\n  <div class="splash-bg"></div>\n  <div class="splash-info">\n    <div class="splash-logo"></div>\n    <div class="splash-intro">\n      {{ \'WELCOME_INTRO\' | translate }}\n    </div>\n  </div>\n  <div padding>\n    <button ion-button block (click)="signup()">{{ \'SIGNUP\' | translate }}</button>\n    <button ion-button block (click)="login()" class="login">{{ \'LOGIN\' | translate }}</button>\n  </div>\n  <div padding>\n    <button ion-button positive outline (click)="skip1()" class="icon ion-log-in" margin-top="10px" >{{ \'WELCOME_SKIP\' | translate }}</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"J:\5551Project\IonicMaxApp\src\pages\welcome\welcome.html"*/
        }),
